...
namespace Builder {
    ...
    class BuilderSourceSpan {
        int start = -1;
        int end = -1;
    }

    class BuilderFidelity {
    ...
    class BuilderScriptBlock {
        string raw;
    }

    class BuilderStylesheetBlock {
        string raw;
    }

    class BuilderTypedProps {
    ...
    class BuilderDocument {
        ...
        string sourceKind = "new"; // new|import_xml|import_live_layer
        string sourceLabel;
        int rootIx = -1;
